...
import { Input, Button, Overlay, Avatar, Header } from "react-native-elements";
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#e5f8f8" }}>
      ...
      <View style={{ alignItems: "center", justifyContent: 'center' }}>
        ...
        <Text style={{ textAlign: "center", fontFamily: "Kohinoor Telugu", fontSize: 20, marginTop: 20 }}>Join an existing group</Text>
        ...
        <Text style={{ fontFamily: "Kohinoor Telugu", fontSize: 20 }}> Create a group </Text>

        <Ionicons name="ios-add-circle-outline" size={60} color="black" onPress={() => { createGroup() }} />


        {/* -------------------------OVERLAY ----- NOUVEAU GROUPE ---------------------------------- */}

        <Overlay overlayStyle={{ backgroundColor: '#dfe6e9', borderRadius: 30, width: 320, }} isVisible={visible} onBackdropPress={createGroup} >
          <View>
            <View style={{ alignItems: 'flex-start', flexDirection: 'row', marginBottom: 30 }}>
              <Button
                title="Return"
                type="clear"
                onPress={() => { back() }}
                buttonStyle={{ borderColor: '#dfe6e9', justifyContent: 'flex-end' }}
                titleStyle={{ color: 'black', fontFamily: 'Kohinoor Telugu', fontSize: 11, marginRight: 35 }}
              />
              <Avatar
                activeOpacity={0.2}
                onPress={pickImage}
              ...
              >
                {image ? <Image source={{ uri: image }} style={{ width: 130, height: 130 }} containerStyle={{ borderRadius: 200 }} /> : <MaterialIcons name="add-a-photo" size={30} color="black" style={{ marginLeft: 40, marginTop: 10, marginBottom: 15, borderWidth: 2, borderRadius: 27, padding: 10 }} />}
              </Avatar>
            </View>

            <View style={{ alignItems: 'center' }}>
              <Text style={{ fontFamily: 'Kohinoor Telugu' }}>Choose the name of your group :</Text>
              <TextInput
                style={{
                  backgroundColor: '#FFFFFF', borderRadius: 30, padding: 12, width: 230, marginTop: 10, marginBottom: 50, textAlign: "center",
                }}
              ...
              <Text style={{ marginBottom: 10, fontFamily: 'Kohinoor Telugu' }}>Generate personal random color :</Text>
              <TouchableOpacity activeOpacity={0.5} style={{ backgroundColor: '#FFFFFF', borderRadius: 45, padding: 5, marginBottom: 50 }}>
                <Image
              ...
              <Text style={{ marginBottom: 10, fontFamily: 'Kohinoor Telugu' }}>Invite your friends :</Text>
              <Button
                title="share the link"
                buttonStyle={{ backgroundColor: 'white', borderRadius: 10, paddingHorizontal: 18, marginBottom: 60, borderWidth: 2, borderColor: '#7FDBDA' }}
              ...
              <Button
                title="Go !"
                buttonStyle={{ backgroundColor: '#7FDBDA', borderRadius: 30, paddingHorizontal: 18 }}
