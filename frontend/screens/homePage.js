...
useEffect(() => {
    ...
    const Preferences = async()=>{
        ...
        if(ifTrue){
            ...
            var rawReponse = await fetch('http://192.168.1.20:3000/find');
...
// Remi IP: http://172.17.1.71:3000
  ...
  var Filters = async() => {
    var rawResult = await fetch('http://192.168.1.20:3000/filters', {
        method: 'POST',
...
var Search = async() => {
    var rawResult = await fetch('http://192.168.1.20:3000/search', {
        method: 'POST',
        headers: {'Content-Type':'application/x-www-form-urlencoded'},
